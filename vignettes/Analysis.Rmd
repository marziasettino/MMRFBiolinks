...
performs an univariate Kaplan-Meier (KM) survival analysis (SA) correlating gene expression and Survival Analysis.The useful arguments for searching  MMRF-CoMMpass Project data are:

**Arguments** | **Description**
-----|-----
clin.mm|is a data.frame using MMRFqueryGDC_clinic function with information related to sample identifier, days_to_death , days_to_last_follow_up , vital_status, etc
dataGE|is a matrix of Gene expression (genes in rows, samples in cols) from MMRFGDC_prepare
